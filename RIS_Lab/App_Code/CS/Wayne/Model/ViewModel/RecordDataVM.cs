...
public class RecordDataVM
{
    ...
    public string SystemRecordVaccineCode {
        get
        {
            if (DoseID != null && DoseID.Length > 0)
            {
                return DoseID;
            }
            else
    ...
    [JsonProperty(PropertyName = "UAD")]
    public DateTime UserAppointmentDate { get; set; }
    ...
    {
        get {
            if (DateTime.Compare(UserAppointmentDate, new DateTime(2099, 1, 1, 1, 1, 1, 0))==0)
            {
    ...
    public int ColorType
    {
        get
        {
            ...
            if (InoculationDateOut != null && AppointmentDate != null && IsRule == true)
            {
                //int flag = DateTime.Compare((DateTime)InoculationDateOut, (DateTime)OriginAppointmentDate);
                int flag = DateTime.Compare((DateTime)InoculationDateOut, (DateTime)AppointmentDate);
                ...
                else
                {
                    ...
                    flag = DateTime.Compare((DateTime)InoculationDateOut, ((DateTime)AppointmentDate).AddDays(90));
