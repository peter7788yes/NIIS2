...
public partial class System_NewsPublishedM_GetNewsPublishedDataOP : BasePage
{
    public System_NewsPublishedM_GetNewsPublishedDataOP()
    {
        base.AddPower("/System/ElectronBulletinM/NewsPublished/NewsPublished.aspx", MyPowerEnum.修改);
    }
