<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MedicalCode.aspx.cs" Inherits="System_CodeM_MedicalCode" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <script>
     ...
     <%:Scripts.Render("~/bundles/MedicalCode_JS")%>
</asp:Content>
