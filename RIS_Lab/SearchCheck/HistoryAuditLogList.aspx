<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="HistoryAuditLogList.aspx.cs" Inherits="SearchCheck_HistoryAuditLogList" %>
    ...
    <div class="formTb  ">
      <table>
              ...
              <tr>
                ...
                <td><input name="SearchDateS"   value='<%=StartDate %>'  id ="SearchDateS" onclick="WdatePicker({ dateFmt: 'yyy-MM', lang: 'zh-tw' })" type="text" class="text04"><a href="#"><img src="/images/icon_calendar.png" onclick="WdatePicker({el:'SearchDateS',dateFmt: 'yyy-MM',lang:'zh-tw'})"></a>
                至 <input name="SearchDateE"   value='<%=EndDate %>'  id ="SearchDateE" onclick="WdatePicker({ dateFmt: 'yyy-MM', lang: 'zh-tw' })" type="text" class="text04"><a href="#"><img src="/images/icon_calendar.png" onclick="WdatePicker({el:'SearchDateE',dateFmt: 'yyy-MM',lang:'zh-tw'})"></a>
  ...
  <!-- form end-->  
        ...
        <div id="tmBlock" style="display:none;" class="listTb"  ng-cloak>
            ...
            <td class="aCenter" ><a ng-click='goDetail(record)'  ng-bind='record["SumCount"]'> </a></td>
                         ...
                         <td class="aCenter"  > <a ng-click='goExport(record)'  href="javascript:void(0);"  >  <img src="/images/icon_download.png" alt="" /></a> </td>
              
                     <td class="aCenter"  > <a ng-click='goHistory(record)'  href="javascript:void(0);">  <img src="/images/icon_details.png" alt="" /></a> </td>
...
<asp:Content ID="Content5" ContentPlaceHolderID="jsCP" Runat="Server">
 ...
 <script>
    ...
    <script src="HistoryAuditLogList.js" type="text/javascript"></script>
</asp:Content>
