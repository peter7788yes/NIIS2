...
namespace WayneDB
{
    public class MSDB
    {
        //static string Conn = WebConfigurationManager.ConnectionStrings["Conn"].ToString();
        static string Conn = "Data Source=10.10.5.212;Initial Catalog=NIIS_Log;Persist Security Info=True;User ID=hygip;Password=hyweb;";
        ...
        //回傳第一資料列第一資料行
        public static string ExecuteScalar(string SQL, params object[] parameters)
        {
            string Rtn = "";
            try
            {
        ...
        //執行語法
        public static string ExecuteScalarWithConn(string ConnectionString, string SQL, params object[] parameters)
        {
            string Rtn = "";
            try
            {
        ...
        //執行語法
        public static int ExecuteNonQueryWithConn(string ConnectionString, string SQL, params object[] parameters)
        {
            int Success = 0;
            try
            {
        ...
        //取得DataTable
        public static DataTable GetDataTableWithConn(string ConnectionString, string SQL, params object[] parameters)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        //取得DataSet
        public static DataSet GetDataSetWithConn(string ConnectionString, string SQL, params object[] parameters)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        //取得DataSet
        public static bool TransactionSQLs(List<string> SQLs, params object[] parameters)
        {
            bool finished = false;
            try
            {
        ...
        //多SQL交易
        public static bool TransactionSQLsWithConn(string ConnectionString, List<string> SQLs, params object[] parameters)
        {
            bool finished = false;
            ...
            try
            {
                ...
                {
                    sc.Open();
                    SqlTransaction trans = sc.BeginTransaction();
                    ...
                    try
                    {
                        ...
                        {
                            SqlCommand cmd = new SqlCommand(SQLs[i], sc);
        ...
        //很快
        public static bool insertWithBulkCopy(string SQL, DataTable dt, string DestinationTableName)
        {
            bool finished = false;
            try
            {
                finished = insertWithBulkCopyWithConn(Conn, SQL, dt, DestinationTableName);
            }
            catch
            {
                throw;
        ...
        //很快
        public static bool insertWithBulkCopyWithConn(string ConnectionString, string SQL, DataTable dt, string DestinationTableName)
        {
            bool finished = false;
            ...
            try
            {
                using (SqlConnection sc = new SqlConnection(ConnectionString))
                {
                    ...
                    try
                    {
                        using (SqlBulkCopy bulkCopy = new SqlBulkCopy(sc, SqlBulkCopyOptions.KeepIdentity, trans))
                        {
        ...
        //public static int insertTable(string TableName, params object[] parameters)
        //{
        //    int Success = 0;
        //    try
        //    {
        ...
        ////懶人insert
        //public static int insertTableWithConn(string ConnectionString, string TableName, params object[] parameters)
        //{
        //    int Success = 0;
        ...
        //public static int updateTable(string TableName, Dictionary<string, string> whereDict, params object[] parameters)
        //{
        //    int Success = 0;
        //    try
        //    {
        ...
        ////懶人insert
        //public static int updateTableWithConn(string ConnectionString, string TableName, Dictionary<string, string> whereDict, params object[] parameters)
        //{
        //    int Success = 0;
        ...
        //public static int deleteTable(string TableName, Dictionary<string, string> whereDict, params object[] parameters)
        //{
        //    int Success = 0;
        //    try
        //    {
        ...
        ////懶人where
        //public static Dictionary<string, string> GetWhere(params object[] parameters)
        //{
        ...
        ////懶人select
        //public static Dictionary<string, string> GetSelect(params object[] parameters)
        //{
        //    if (CheckParam(parameters) == false)
        //        throw new Exception("請檢查，參數有錯誤。");
        ...
        private static bool CheckParam(params object[] parameters)
        {
            bool Rtn = true;
            ...
            for (int i = 0; i <= parameters.Length - 1; i++)
            {
                if (i % 2 == 0)
                {
                    if (parameters[i].ToString().StartsWith("@") == false)
                        Rtn = false;
                }
            }
