$(function () {
    $(document).on("click", ".UploadIdNoFiles", function (e) {
        ...
        var iWidth = 502;  //視窗的寬度;
        var iHeight = 230 ; //視窗的高度;
        var iTop = (window.screen.availHeight - 30 - iHeight) / 2;  //視窗的垂直位置;
        var iLeft = (window.screen.availWidth - 10 - iWidth) / 2;   //視窗的水平位置;
        window.open("/CaseMaintain/GetIdNoFromUploadFile.aspx", "UserContractList", "width=" + iWidth + ",height=" + iHeight + ",top=" + iTop + ",left=" + iLeft + ",toolbar=no,menubar=no,scrollbars=yes,resizable=yes");
        e.preventDefault();
        return false;
