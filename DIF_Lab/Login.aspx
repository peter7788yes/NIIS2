  ...
  <section class="login"> 
    ...
    <section class="login_right">
      <div>
        ...
        使用健保IC卡讀卡機</div>
      <ul>
        <li><asp:LinkButton ID="btnLogin" runat="server" Text="登入系統" OnClick="btnLogin_Click" /></li>
        <li><asp:LinkButton ID="LinkButton1" runat="server" Text="取得OTP" OnClick="btnLogin_Click" /></li>
        <li><asp:LinkButton ID="LinkButton2" runat="server" Text="忘記密碼" OnClick="btnLogin_Click" /></li>
        <li><asp:LinkButton ID="LinkButton3" runat="server" Text="申請帳號" OnClick="btnLogin_Click" /></li>
      </ul>
    </section>
    <!--登入右欄 end --> 
