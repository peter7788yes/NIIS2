<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RolePowerSetting_Update.aspx.cs" Inherits="System_PowerM_RolePowerSetting_Update" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
     ...
     <%:Scripts.Render("~/bundles/RolePowerSetting_Update_JS")%>
</asp:Content>
