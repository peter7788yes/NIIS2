            ...
            <div class="formTb">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="tbAccount" CssClass="text02" ClientIDMode="Static" runat="server" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <asp:TextBox ID="tbR1"  Columns="70" Rows="5" TextMode="MultiLine"  CssClass="text01" ClientIDMode="Static" runat="server" /></td>
                    </tr>
                    <tr>
                        <th scope="row">備註:</th>
                        <td colspan="2">
                            <asp:TextBox ID="tbR2"  Columns="70" Rows="5" TextMode="MultiLine"   CssClass="text01" ClientIDMode="Static" runat="server" /></td>
                    </tr>
                    <tr>
                        <th scope="row">申請單:</th>
                        <td colspan="2">
                            <asp:FileUpload ID="tbFile"  Multiple="Multiple" CssClass="text01" ClientIDMode="Static"   runat="server"  /><span style="color:blue;">(格式不限，大小限3M以內)</span></td>
                    </tr>
                </table>
            </div>
        </form>
