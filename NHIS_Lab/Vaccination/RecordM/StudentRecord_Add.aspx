<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentRecord_Add.aspx.cs" Inherits="Vaccination_RecordM_StudentRecord_Add"  MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <script>
     ...
     <%:Scripts.Render("~/bundles/StudentRecord_Add_JS")%>
</asp:Content>
