<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterData.aspx.cs" Inherits="VaccinationM_RegisterData"  MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="jsCP" Runat="Server">
    <%:Scripts.Render("~/bundles/RegisterData_JS")%>
