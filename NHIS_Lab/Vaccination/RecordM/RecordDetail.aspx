...
<asp:Content ID="cpCT" ContentPlaceHolderID="ctCP" runat="Server">
  ...
  <tr ng-show="TM.ApplyRecord.length>0"  ng-repeat="record in TM.ApplyRecord track by $index">
                                      <td class="aCenter"><a href="javascript:void(0);" ng-bind="record['ID'] | SimpleTaiwanDate"></a></td>   
                                      ...
                                      <td class="aCenter" ng-bind="record['CN']"></td>
                                      <td class="aCenter">{{record['RSR']}}{{record['RIR']}}{{record['ELR']}}</td>
                                      <td class="aCenter"><a href="javascript:void(0);" ng-click="RemoveApplyRecord(record)"><img src="/images/icon_del01.gif" /></a></td>
    </tr> 
