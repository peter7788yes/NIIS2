<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BCGRecord_Add.aspx.cs" Inherits="Vaccination_RecordM_BCGRecord_Add" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
     <%:Scripts.Render("~/bundles/BCGRecord_Add_JS")%>
</asp:Content>
