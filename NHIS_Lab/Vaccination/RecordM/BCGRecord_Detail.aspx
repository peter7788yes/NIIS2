<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BCGRecord_Detail.aspx.cs" Inherits="Vaccination_RecordM_BCGRecord_Detail" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <script>
     ...
     <%:Scripts.Render("~/bundles/BCGRecord_Detail_JS")%>
</asp:Content>
