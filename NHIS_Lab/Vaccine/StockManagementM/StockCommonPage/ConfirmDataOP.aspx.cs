...
public partial class Vaccine_StockManagementM_StockCommonPage_ConfirmDataOP : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_Vaccine" + PageType + "_xConfirmData", sc))
            {
