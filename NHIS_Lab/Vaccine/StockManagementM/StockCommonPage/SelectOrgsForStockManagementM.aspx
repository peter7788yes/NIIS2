<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectOrgsForStockManagementM.aspx.cs" Inherits="Vaccine_StockManagementM_StockCommonPage_SelectOrgsForStockManagementM" %>
<!doctype html>
<html lang="zh-TW">
<head>
...
<section class="Content2">
  ...
  <form>
            ...
            <li> 
              ...
              <div id="div1" class="formTb formTb2">
                <table>
                  ...
                  <tr>
                    <%if (MyLevel == 1 || MyLevel+1 == 1 || MyLevel-1 == 1){ %>
                    <td width="20%">
                    ...
                    <%} %>
                    <%if (MyLevel == 2 || MyLevel + 1 == 2 || MyLevel - 1 == 2){ %>
                    <td width="20%">
                        <a href="javascript:void(0);">
                    ...
                    <%} %>
                    <%if (MyLevel == 3 || MyLevel + 1 == 3 || MyLevel - 1 == 3){ %>
                    <td width="20%">
                        <a href="javascript:void(0);">
                    ...
                    <%} %>
                    <%if (MyLevel == 4 || MyLevel + 1 == 4 || MyLevel - 1 == 4){ %>
                    <td width="20%">
                        <a href="javascript:void(0);">
                    ...
                    <%} %>
                    <%if (MyLevel == 5 || MyLevel + 1 == 5 || MyLevel - 1 == 5){ %>
                    <td width="20%">
                        <a href="javascript:void(0);">
    ...
    <script src="/Vaccine/StockManagementM/StockCommonPage/SelectOrgsForStockManagementM.js"></script>
</body>
</html>
