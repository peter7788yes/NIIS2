<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Modify_VaccineOutBatch.aspx.cs" Inherits="Vaccine_StockManagementM_VaccineOut_Modify_VaccineOutBatch" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<div class="path"></div>
    <section class="Content" ng-app="VaccineOutApp" ng-controller="ModifyVaccineOutDataController" ng-cloak>
