...
public partial class Vaccine_StockManagementM_VaccineOut_Modify_VaccineOutBatch : BasePage
{
    ...
    public Vaccine_StockManagementM_VaccineOut_Modify_VaccineOutBatch()
    {
        list = base.AddPower("/Vaccine/StockManagementM/VaccineOut/VaccineOut.aspx", MyPowerEnum.修改, MyPowerEnum.上傳);
    }
