<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_VaccineOutBatch.aspx.cs" Inherits="Vaccine_StockManagementM_VaccineOut_View_VaccineOutBatch" MasterPageFile="~/MasterPage/MasterPage.master" %>
    ...
    <form name="form1" id="form1" runat="server">
        ...
        <div class="formTb formTb2">
            <table>
                ...
                <tr>
                    <th scope="row"><span class="must">*</span>撥出類型：</th>
                    <td colspan="3">
                        <asp:DropDownList ID="DealType" runat="server"></asp:DropDownList>
                        <asp:Label ID="DealHospitalName" ClientIDMode="Static" CssClass="text02" Visible="false" runat="server" ReadOnly="True"></asp:Label>
