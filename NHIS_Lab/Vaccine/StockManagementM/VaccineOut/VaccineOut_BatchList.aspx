<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VaccineOut_BatchList.aspx.cs" Inherits="Vaccine_StockManagementM_VaccineOut_VaccineOut_BatchList" MasterPageFile="~/MasterPage/MasterPage.master"%>
...
<div class="path"></div>
    <section class="Content" ng-app="VaccineOutApp" ng-controller="VaccineOutBatchListController" ng-cloak>
        <form name="form1" id="form1" >
            <div class="formTb formTb2">
                <table>
                    <tr>
                        <th scope="row"><span class="must">*</span>撥出疫苗：</th>
                        <td colspan="3">
