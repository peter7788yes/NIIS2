...
public partial class Vaccine_StockManagementM_VaccineIn_View_VaccineInBatch : BasePage
{
    public MyPowerVM DownloadPower = new MyPowerVM("", default(MyPowerEnum));

    public Vaccine_StockManagementM_VaccineIn_View_VaccineInBatch()
    {
        DownloadPower = base.AddPower("/Vaccine/StockManagementM/VaccineIn/VaccineIn.aspx", MyPowerEnum.下載);
    }
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.IsPostBack == false)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                DownloadFile.PostBackUrl = "/Vaccine/StockManagementM/VaccineIn/DownloadFileOP.aspx?i=" + dt1.Rows[0]["FileInfoID"].ToString();
