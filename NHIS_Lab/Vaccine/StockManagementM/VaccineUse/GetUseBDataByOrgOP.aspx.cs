...
public partial class Vaccine_StockManagementM_VaccineUse_GetUseBDataByOrgOP : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("usp_VaccineUse_xGetSelectData1", sc))
            {
