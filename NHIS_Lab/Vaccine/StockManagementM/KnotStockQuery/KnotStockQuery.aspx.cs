...
public partial class Vaccine_StockManagementM_KnotStockQuery_KnotStockQuery : BasePage
{
    ...
    public Vaccine_StockManagementM_KnotStockQuery_KnotStockQuery()
    {
        list = base.AddPower("/Vaccine/StockManagementM/KnotStockQuery/KnotStockQuery.aspx", MyPowerEnum.查詢, MyPowerEnum.列印);
    }
