<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterData_Detail_FluNotes.aspx.cs" Inherits="Vaccination_RecordM_RegisterData_Detail_FluNotes" MasterPageFile="~/MasterPage/Custom/DecoratedMasterPage.master" %>
    ...
    <section class="Content2">
       ...
       <form id="form1" runat="server"  autocomplete="off">
            ...
            <div class="formBtn">
                ...
                <input type="hidden" name="i"  value="<%=FluNotesID %>" />
            </div>
        </form>
    </section>
</asp:Content>
