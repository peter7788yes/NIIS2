...
public partial class Vaccination_RecordM_StudentRecord_ExportSchoolCodeOP : BasePage
{
    public Vaccination_RecordM_StudentRecord_ExportSchoolCodeOP()
    {
        base.AddPower("/Vaccination/RecordM/StudentRecord.aspx", MyPowerEnum.下載);
    }
