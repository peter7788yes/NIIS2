...
<script runat="server">
    ...
    void Application_Start(object sender, EventArgs e)
    {
		...
		//SystemVaccineData.Update();
       // SystemVaccineBatchData.Update();
    ...
    void Application_AcquireRequestState(object sender, EventArgs e)
    {
        ...
        List<string> list = new List<string>() {
                                                 ...
                                                 ,"/OTPApply.aspx".ToLower()
                                                 ,"/html5shiv/dist/html5shiv.min.js".ToLower()
                                               };

        if (list.Contains(path) == false)
        {
            if (path.StartsWith("/bundles/") == false && path.StartsWith("/account/") == false)
            {
