      ...
      <table>
        ...
        <tr>
          ...
          <td><asp:TextBox required="required" ClientIDMode="Static" maxlength="4" ID="tbCode" CssClass="text02"  onfocus="javascript:this.select();" runat="server" />
            <img id="imgCode" style="cursor:pointer" src="" width="107" height="29" alt="換一個" title="換一個" onclick="Change(this)" />
           </td>
        </tr>
        <tr>
    ...
    <section class="login_right">
      ...
      <ul>
        <li><asp:Button ID="btnLogin" runat="server" ClientIDMode="Static" Text="登入系統" OnClick="btnLogin_Click" 
            ...
            cursor:pointer;
            text-align: left;"/></li>
        <li><asp:LinkButton ID="btnApplyOTP" runat="server" ClientIDMode="Static" Text="取得OTP" PostBackUrl="~/OTPApply.aspx" /></li>
        <li><asp:LinkButton ID="LinkButton2" runat="server" ClientIDMode="Static" Text="忘記密碼" OnClick="btnLogin_Click" /></li>
        <li><asp:LinkButton ID="btnApplyAccount" runat="server" ClientIDMode="Static" Text="申請帳號" PostBackUrl="~/Account/ApplyAccount.aspx" /></li>
      </ul>
    </section>
  </section>
  <footer>
