<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentMaintain.aspx.cs" Inherits="DocumentManagementM_DocumentMaintain" MasterPageFile="~/MasterPage/Custom/DecoratedMasterPage.master" %>
                ...
                <div class="formTb">
                    <table>
                        <tr>
                            <th scope="row">標題：</th>
                            <td>
                                <input name="title" type="text" class="text01" ng-model="VM.title" /></td>
                        </tr>
                        <tr>
