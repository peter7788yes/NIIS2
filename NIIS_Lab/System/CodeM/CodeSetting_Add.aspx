<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CodeSetting_Add.aspx.cs" Inherits="System_CodeM_CodeSetting_Add" MasterPageFile="~/MasterPage/Custom/DecoratedMasterPage.master" %>
                 ...
                 <table>
                  <tr>
                    ...
                    <td>
                        ...
                        <input name="ii" id="ii" type="hidden" value="<%=ID %>" />
                    </td>
                  </tr>
                  <tr>
