...
namespace WayneBundles
{
    public class JsCssBundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //UC
            UC_SelectAgency_Bundle.RegisterBundles(bundles, predicate);
            UC_SelectSingleOrg_Bundle.RegisterBundles(bundles, predicate);
            UC_SelectOrgs_Bundle.RegisterBundles(bundles, predicate);
            ...
            AccountMaintain_Maintain_Bundle.RegisterBundles(bundles, predicate);
            ...
            CodeSetting_DetailMaintain_Bundle.RegisterBundles(bundles, predicate);
            ...
            WorkloadStatistics_Bundle.RegisterBundles(bundles, predicate);

            WorkloadStatistics_Business_Bundle.RegisterBundles(bundles, predicate);
