...
public class HanbaoAuditReportM_Bundle
{
    public static void RegisterBundles(BundleCollection bundles, Predicate<string> predicate)
    {
        string cssPath = "~/bundles/HanbaoAuditReport_CSS";
        string jsPath = "~/bundles/HanbaoAuditReport_JS";
        ...
        List<string> jsList = new List<string>(new[]{
                                  ...
                                  , "~/js/ang/InputM.js"
                                  , "~/js/ang/PageM.min.js"
                                  , "~/Report/VaccineM/HanbaoAuditReport/HanbaoAuditReport.js"
                                 });
