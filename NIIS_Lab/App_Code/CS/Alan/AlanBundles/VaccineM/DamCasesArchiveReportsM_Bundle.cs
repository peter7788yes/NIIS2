...
public class DamCasesArchiveReportsM_Bundle
{
    public static void RegisterBundles(BundleCollection bundles, Predicate<string> predicate)
    {
        string jsPath = "~/bundles/DamCasesArchiveReports_JS";
        ...
        List<string> jsList = new List<string>(new[]{
                                  ...
                                  , "~/js/ang/InputM.js"
                                  , "~/js/ang/PageM.min.js"
                                  , "~/Report/VaccineM/DamCasesArchiveReports/DamCasesArchiveReports.js"
                                 });
