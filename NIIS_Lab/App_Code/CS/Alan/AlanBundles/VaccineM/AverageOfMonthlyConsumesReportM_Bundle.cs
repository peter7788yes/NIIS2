...
public class AverageOfMonthlyConsumesReportM_Bundle
{
    public static void RegisterBundles(BundleCollection bundles, Predicate<string> predicate)
    {
        string jsPath = "~/bundles/AverageOfMonthlyConsumesReport_JS";
        ...
        List<string> jsList = new List<string>(new[]{
                                  ...
                                  , "~/js/ang/InputM.js"
                                  , "~/js/ang/PageM.min.js"
                                  , "~/Report/VaccineM/AverageOfMonthlyConsumesReport/AverageOfMonthlyConsumesReport.js"
                                 });
