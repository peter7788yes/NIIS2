...
/// <summary>
/// OrgsBalanceMonthlyReportM_Bundle 的摘要描述
/// </summary>
public class OrgsBalanceMonthlyReportM_Bundle
{
    public static void RegisterBundles(BundleCollection bundles, Predicate<string> predicate)
    {
        string jsPath = "~/bundles/OrgsBalanceMonthlyReport_JS";
        ...
        List<string> jsList = new List<string>(new[]{
                                  ...
                                  , "~/js/ang/InputM.js"
                                  , "~/js/ang/PageM.min.js"
                                  , "~/Vaccine/StockManagementM/OrgsBalanceMonthlyReport/OrgsBalanceMonthlyReport.js"
                                 });
