...
public class CaseUrgeSettingListVM
{
    ...
    public string UrgeKind { get; set; }

    [JsonProperty(PropertyName = "UKN")]
    public string UrgeKindName { get { return (SystemCode.GetName("CaseUrge_UrgeKind", Convert.ToInt32(UrgeKind)) ?? ""); } }
