<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VaccinationDetail_SelectAgency.aspx.cs" Inherits="Report_VaccinationM_VaccinationDetail_SelectAgency" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <%:Scripts.Render("~/bundles/VaccinationDetail_SelectAgency_JS")%>
</asp:Content>