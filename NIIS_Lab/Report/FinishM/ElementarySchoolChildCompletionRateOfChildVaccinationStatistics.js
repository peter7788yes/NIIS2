...
angular.module("MyApp", [])
         .controller("MyController", ["$scope", function ($scope) {
             ...
             $scope.goPrint = function () {
                 ...
                 keys[0] = '1';
                 values[0] = 1;
                 openWindowWithPost("/Report/FinishM/ElementarySchoolChildCompletionRateOfChildVaccinationStatistics_Print.aspx", "AbnormalVaccinationDetail_Print", 930, 630, keys, values);
             };
