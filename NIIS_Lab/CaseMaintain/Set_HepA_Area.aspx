<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Set_HepA_Area.aspx.cs" Inherits="CaseMaintain_Set_HepA_Area" %>
...
若個案的戶籍地於以下列表者，則具有【A型肝炎疫苗實施地區】個案身分
<table>
<tr><td>
