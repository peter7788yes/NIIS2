...
public partial class CaseMaintain_Set_FarTown_Area : System.Web.UI.Page
{
...
order by SettingID desc"
    ...
    protected void ddlCounty_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        DataTable dt = (DataTable)DBUtil.DBOp("ConnDB", @"SELECT [id] ,[AreaName]  FROM [dbo].[S_SystemAreaCode] where [AreaParent]= {0}"
            , new string[] { ddlCounty .SelectedValue }, NSDBUtil.CmdOpType.ExecuteReaderReturnDataTable);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        DBUtil.DBOp("ConnDB", @"INSERT INTO [dbo].[C_CaseUserCapacity_FarTownSetting] ([CountyID] ,[TownID]) VALUES ({0},{1})"
            , new string[] { ddlCounty .SelectedValue,ddlTown.SelectedValue }, NSDBUtil.CmdOpType.ExecuteNonQuery);
