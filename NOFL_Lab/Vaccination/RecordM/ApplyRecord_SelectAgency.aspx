<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplyRecord_SelectAgency.aspx.cs" Inherits="Vaccination_ParameterM_ApplyRecord_SelectAgency" MasterPageFile="~/MasterPage/MasterPage.master" %>
                    ...
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            <input type="button" value="查詢" ng-click="goSearch()" class="btn" />
                         </td>
                    </tr>
                    </table>
        </div>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <%:Scripts.Render("~/bundles/ApplyRecord_SelectAgency_JS")%>
</asp:Content>