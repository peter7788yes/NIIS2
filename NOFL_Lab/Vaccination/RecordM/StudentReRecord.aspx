<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentReRecord.aspx.cs" Inherits="Vaccination_RecordM_StudentReRecord" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="cpCT" ContentPlaceHolderID="ctCP" runat="Server">
  ...
  <section class="Content" ng-app="MyApp" ng-controller="MyController" ng-cloak>
        ...
        <div class="formBtn formBtnleft">
               <input type="button" id="searchBtn" value="查詢" class="btn" />
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    ...
    <%:Scripts.Render("~/bundles/StudentReRecord_JS")%>
