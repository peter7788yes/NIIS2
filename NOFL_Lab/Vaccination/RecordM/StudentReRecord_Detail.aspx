<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentReRecord_Detail.aspx.cs" Inherits="Vaccination_RecordM_StudentReRecord_Detail"  MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <script>
     ...
     <%:Scripts.Render("~/bundles/StudentReRecord_Detail_JS")%>
</asp:Content>
