<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocationSetting_SelectAgency.aspx.cs" Inherits="Vaccination_ParameterM_LocationSetting_SelectAgency" MasterPageFile="~/MasterPage/MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="jsCP" runat="Server">
    <%:Scripts.Render("~/bundles/LocationSetting_SelectAgency_JS")%>
</asp:Content>