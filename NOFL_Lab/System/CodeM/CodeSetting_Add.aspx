         ...
         <form id="form1" runat="server" defaultbutton="btnSave">
            ...
            <div class="formTb">
                 <table>
                  <tr>
                    <th scope="row">代碼：</th>
                    <td><asp:Literal ID="lblCate" ClientIDMode="Static"  runat="server"  /></td>
                  </tr>
                  <tr>
                    <th scope="row"><span class="must">*</span>代碼值:</th>
                    <td><asp:TextBox ID="tbValue" CssClass="text01" ClientIDMode="Static"  runat="server"  /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><asp:TextBox ID="tbSort" CssClass="text01" ClientIDMode="Static"  runat="server"  /></td>
                  </tr>
                 </table>
            </div>
        </form>
