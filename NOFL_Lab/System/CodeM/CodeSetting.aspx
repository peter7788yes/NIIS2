...
<asp:Content ID="cssCT" ContentPlaceHolderID="cssCP" runat="Server">
    <%:Styles.Render("~/bundles/CodeSetting_CSS")%>
</asp:Content>
        ...
        <div id="tmBlock" style="display:none;" class="listTb"  ng-cloak>
            <table>
                ...
                <tr ng-repeat="record in TM.data track by $index">
                      ...
                      <td class="aCenter" ng-bind='record["CD"]'></td>
                      <td class="aCenter" ng-bind='record["R"]'></td>
                      <td class="aCenter"><a href="javascript:void(0);"><img src="/images/icon_maintain.png" ng-click="AddCode(record)" /></a></td>
                </tr>
            </table>
        </div>
    </section>
